...
import { idlFactory } from './splitchain_frontend.did.js';
export { idlFactory } from './splitchain_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SPLITCHAIN_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./splitchain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the splitchain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./splitchain_frontend.did.js")._SERVICE>}
 */
export const splitchain_frontend = createActor(canisterId);
